...
public class Enemy {
    ...
    public void attack(Player player) {
        if (player.evade()) {
            System.out.println(player.getName() + " esquivó el ataque de " + name + "!");
            return;
        }
        ...
        int damageDealt = baseDamage - player.getStat(Stats.DEFENSE);
        damageDealt = Math.max(damageDealt, 0); /* El daño mínimo es 0*/

        /* Mostrar el mensaje del ataque*/
        System.out.println(name + " ataca a " + player.getName() + " causando " + damageDealt + " de daño.");

        player.takeDamage(damageDealt); /* Aplicar el daño*/
    }
